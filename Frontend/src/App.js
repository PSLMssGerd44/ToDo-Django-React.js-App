  ...
  render (){
    return(
      <main className="content p-3 mb-2 bg-info">
        ...
        <div className="row">
          <div className="col-md-5 col-sma-9 mx-auto p-0">
        ...
        <footer className="my-3 mb-2 bg-info text-white text-center">Nidum technical assessment - FullStack React.js Django Developer</footer>
        {this.state.modal ? (
